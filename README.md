...
Just so you don't have to look for the information about dependencies and building the tool, I have included a copy of the material here. It is possible that the pre-compiled structure.py in the repository works for you (you are welcome to try). If not, delete the file (```rm structure.py```) and run through the installation process. Enjoy
